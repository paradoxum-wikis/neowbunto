...
(local {: build-table-cache
        : build-page-cache
        : build-page-cache-from-text
        : cache-get
        : rof-bug
        : scope-page-cache} (require :tablecache))
...
(fn run []
  ...
  (let [ast (parse-table electroshocker-table {})
    ...
    (assert-eq (. (cache-get cache 0 "") "DPS") "$DPS$"
               "unresolved formula kept")
  ...
  (let [ast (parse-table electroshocker-table {})
        cache (build-table-cache ast "Level"
                                 {:rof-cols {"Firerate" true} :rof-offset 0.05})]
  ...
  (let [tables (parse-all-tables harvester-page {})
        page (build-page-cache tables
                               {:rof-cols {"Firerate" true} :rof-offset nil})]
  ...
  (let [page (build-page-cache-from-text "{| \n! colspan=\"2\" |Base Stats\n|-\n! Level !! Damage\n|-\n| 0 || 10\n|-\n| 1 || 15\n|}"
                                         {} {})
        ctx (make-ctx {:level 1 :table-cache page :row {}})]
